...
void parlcd_write_cr(mem_address_map_t * parlcd_mem_base, uint16_t data) {
  *(volatile uint16_t * )(((uint8_t * ) parlcd_mem_base -> regs_base_virt) + PARLCD_REG_CR_o) = data;
}

void parlcd_write_cmd(mem_address_map_t * parlcd_mem_base, uint16_t cmd) {
  *(volatile uint16_t * )(((uint8_t * ) parlcd_mem_base -> regs_base_virt) + PARLCD_REG_CMD_o) = cmd;
}

void parlcd_write_data(mem_address_map_t * parlcd_mem_base, uint16_t data) {
  *(volatile uint16_t * )(((uint8_t * ) parlcd_mem_base -> regs_base_virt) + PARLCD_REG_DATA_o) = data;
}

void parlcd_write_data2x(mem_address_map_t * parlcd_mem_base, uint32_t data) {
  *(volatile uint32_t * )(((uint8_t * ) parlcd_mem_base -> regs_base_virt) + PARLCD_REG_DATA_o) = data;
}
